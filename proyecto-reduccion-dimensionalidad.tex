...
{\centering \includegraphics{proyecto-reduccion-dimensionalidad_files/figure-latex/tsne1-1} 

}

\caption{Salida de \texttt{tsne()} con parámetros por defecto, coloreada según \texttt{Chance of Admit}}\label{fig:tsne1}
\end{figure}
