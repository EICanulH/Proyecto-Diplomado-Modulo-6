...
Las salidas gráficas de ambas rejillas (Figuras\textasciitilde{}\ref{fig:tsnegrideta} y\textasciitilde{}\ref{fig:tsne-grid-ampliada}) aportan el elemento decisivo: la nube continua con gradiente de \texttt{Chance of Admit} está presente en las cuarenta configuraciones evaluadas, sin que ninguna combinación de hiperparámetros produzca agrupamientos discretos. Las diferencias entre paneles se limitan a la extensión y la orientación del mapa, ambas irrelevantes para la interpretación. El hallazgo descrito a partir de la Figura\textasciitilde{}\ref{fig:tsne-exacta} no depende, por tanto, de la configuración elegida. Cabe señalar que la rejilla ampliada corrió con \texttt{verbose = FALSE}, por lo que \texttt{eta = 200} carece de divergencia registrada y quedó fuera de la Tabla\textasciitilde{}\ref{tab:tsne-grid}.
